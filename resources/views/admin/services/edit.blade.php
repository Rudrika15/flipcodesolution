                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" value="{{ $services->photo }}" accept="image/*" name="photo"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor form-control" style="height:150px" name="detail" placeholder="Detail">{{ $services->detail }}</textarea>
